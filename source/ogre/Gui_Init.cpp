...
void App::InitGui()
{
	...
	{0.54,0.88,0.60,0.7}, {0.51,0.90,0.50,0.1},  // cyan
	{0.43,0.57,0.30,0.5}, {0.41,0.43,0.23,0.1},  // dark-cyan
	{0.37,0.78,0.23,0.5}, {0.35,0.70,0.40,0.5}, {0.38,0.97,0.60,0.5},  // dark-blue
	{0.43,0.80,0.80,0.3}, {0.47,0.90,0.71,1.0}, // sky-blue
	...
	vel["N1"] = 5;  yr["N1"] = 1999;  vel["NS"] = 4;  yr["NS"] = 1989;  vel["S1"] = 4;  yr["S1"] = 2005;
