...
void App::LoadInputDefaults()
{
	...
	mInputActions.push_back(InputAction(A_Screenshot, "Screenshot", SDLK_F11, InputAction::Trigger));
	...
	mInputActionsPlayer[0].push_back(InputAction(A_NextCamera, "NextCamera", SDLK_c, InputAction::Trigger));
	mInputActionsPlayer[0].push_back(InputAction(A_LastChk, "LastChk", SDLK_F12, InputAction::Trigger));
	mInputActionsPlayer[0].push_back(InputAction(A_Rewind, "Rewind", SDLK_BACKSPACE, InputAction::Trigger));
	...
	mInputActionsPlayer[1].push_back(InputAction(A_NextCamera, "NextCamera", SDLK_UNKNOWN, InputAction::Trigger));
	mInputActionsPlayer[1].push_back(InputAction(A_LastChk, "LastChk", SDLK_UNKNOWN, InputAction::Trigger));
	mInputActionsPlayer[1].push_back(InputAction(A_Rewind, "Rewind", SDLK_UNKNOWN, InputAction::Trigger));
	...
	mInputActionsPlayer[2].push_back(InputAction(A_NextCamera, "NextCamera", SDLK_UNKNOWN, InputAction::Trigger));
	mInputActionsPlayer[2].push_back(InputAction(A_LastChk, "LastChk", SDLK_UNKNOWN, InputAction::Trigger));
	mInputActionsPlayer[2].push_back(InputAction(A_Rewind, "Rewind", SDLK_UNKNOWN, InputAction::Trigger));
	...
	mInputActionsPlayer[3].push_back(InputAction(A_NextCamera, "NextCamera", SDLK_UNKNOWN, InputAction::Trigger));
	mInputActionsPlayer[3].push_back(InputAction(A_LastChk, "LastChk", SDLK_UNKNOWN, InputAction::Trigger));
	mInputActionsPlayer[3].push_back(InputAction(A_Rewind, "Rewind", SDLK_UNKNOWN, InputAction::Trigger));
