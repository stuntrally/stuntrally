...
App::App(SETTINGS *settings, GAME *game)
	...
	,listServers(0), listPlayers(0), edNetChat(0), imgNetTrack(0), liNetEnd(0)
	...
	,edChampStage(0),edChampEnd(0), edChampInfo(0)
	,btStTut(0), btStChamp(0), btStChall(0), tabTut(0),tabChamp(0),tabChall(0), imgTut(0),imgChamp(0),imgChall(0)
	,imgChampStage(0),imgChampEnd(0), valStageNum(0), btChampStage(0)
	// other
