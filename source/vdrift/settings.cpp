...
void SETTINGS::Serialize(bool w, CONFIGFILE & c)
{
	...
	Param(c,w, "hud_show.car_dbgsurf", car_dbgsurf);	Param(c,w, "hud_show.car_dbgtxtclr", car_dbgtxtclr);
...
SETTINGS::SETTINGS() :  ///  Defaults
	...
	car_dbgtxt(0), car_dbgbars(0), car_dbgsurf(0), show_graphs(0), car_dbgtxtclr(0),
