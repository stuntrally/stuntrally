...
App::App()  //  gui wigdets--
	...
	,valShaders(0), valShadowType(0), valShadowCount(0), valShadowSize(0), valShadowDist(0), valShadowFilter(0)  // shadow //shadow
	...
	,edGrDensSmooth(0), edGrTerMaxAngle(0), edSceneryId(0), cmbGrassMtr(0), cmbGrassClr(0)
