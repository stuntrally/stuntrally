...
//ahmedismaiel:replaced with a pointer version due to VS11 build error
//btAlignedObjectArray.h(304)error C2719: 'CompareFunc': formal parameter with __declspec(align('16')) won't be aligned
