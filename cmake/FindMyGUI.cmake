...
IF (NOT MYGUI_FOUND AND VCPKG_TOOLCHAIN)
  add_library(MyGUIEngineInterface INTERFACE)
  target_compile_definitions(MyGUIEngineInterface INTERFACE MYGUI_STATIC)
  ...
  set(MYGUI_LIBRARIES ${MYGUI_LIBRARIES_REL} ${MYGUI_LIBRARIES_DBG})
  target_link_libraries(MyGUIEngineInterface INTERFACE Freetype::Freetype)
  set(MYGUI_LIBRARIES MyGUIEngineInterface "${MYGUI_LIBRARIES}")
  set(MYGUI_FOUND TRUE)
ENDIF (NOT MYGUI_FOUND AND VCPKG_TOOLCHAIN)
