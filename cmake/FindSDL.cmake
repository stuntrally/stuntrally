...
# SDL_INCLUDE_DIRSS, where to find SDL.h
#
...
#MESSAGE("SDL_INCLUDE_DIRS is ${SDL_INCLUDE_DIRS}")
...
IF(NOT SDL_BUILDING_LIBRARY)
  ...
  ENDIF(NOT ${SDL_INCLUDE_DIRS} MATCHES ".framework")
...
IF(SDL_LIBRARY_TEMP)
  ...
  SET(SDL_LIBRARY ${SDL_LIBRARY_TEMP} CACHE INTERNAL "")
  # Set the temp variable to INTERNAL so it is not seen in the CMake GUI
  SET(SDL_LIBRARY_TEMP "${SDL_LIBRARY_TEMP}" CACHE INTERNAL "")

  # Set the recommended variable name
  SET(SDL_LIBRARIES ${SDL_LIBRARY})

  MARK_AS_ADVANCED(SDLMAIN_LIBRARY SDL_LIBRARIES SDL_INCLUDE_DIRS)
